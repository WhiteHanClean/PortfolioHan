...
import SamuraiModel from "../components/Scene";
    ...
    <>
      ...
      >
        ...
        <section data-scroll-section>
          <div className="relative w-full lg:grid-cols-8 bg-dark text-light h-screen flex ">
            <motion.div
              variants={itemLeft}
              className="z-10 w-2 hero_text leading lg:grid-cols-8 md:text-left text-center space-y-4 col-span-full lg:col-start-2 flex flex-col items-center justify-center lg:col-end-6 lg:h-screen h-full"
            >
              <div className="md:text-5xl text-3xl font-bold uppercase">
                ...
                <span className="md:text-7xl text-5xl text-stroke">Arykbaev</span>{" "}
                 Front-End
              </div>
            ...
            >
              ...
              <SamuraiModel setLoading={setLoading}/>
            </motion.div>
            <motion.div
              variants={itemBottom}

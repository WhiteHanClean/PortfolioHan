      ...
      >
        <div className="inline-flex flex-col items-center md:items-start space-y-6">
          ...
          <div className="inline-flex items-center md:items-start flex-col text-4xl md:text-7xl font-bold tracking-widest leading-10 uppercase">
            <div>
              <span className="text-stroke">Ilgiz</span>Han
            </div>
            <div className="text-2xl md:text-7xl">Arykbaev</div>
          </div>
          <div className="max-w-3xl text-center md:text-left">
            I am a developer who follows trends and respects quality. I am
            always looking for new opportunities for professional growth. I am a
            great team player, but I can also make good individual
            contributions. My soft skills: responsible, neat, I like
            self-development, easy-going. Core Skills: JS(native, jqery),
            React(Redux/thunk/saga/toolkit), HTML, CSS, SASS, Node Js,
            Typescript, Next Js, Miu, Antd, Bootstrap , Firebase, Mobx, RTK
            Query, D3, I18next, lazyLoad, Styled-components
          </div>
        </div>
      </motion.section>
      <section
